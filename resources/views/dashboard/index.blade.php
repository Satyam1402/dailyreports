        ...
        <section class="content">
                ...
                <div class="row">
                    ...
                    {{-- <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success" style="border-radius: 15px;">
                            <div class="inner">
                                @php
                                    $totalSubCategory = \App\Models\Sub_category::count();
                                @endphp
                    ...
                    {{-- <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning" style="border-radius: 15px;">
                            <div class="inner">
                                @php
                                      $totalTags = \App\Models\VideoTag::distinct('tag')->count('tag');
                                  @endphp
                                  <h3 style="color: #fff ;">{{ $totalTags }}</h3>
                    ...
                    {{-- <div class="col-lg-3 col-6">
                      <!-- small box -->
                      <div class="small-box bg-secondary" style="border-radius: 15px;">
                          <div class="inner">
                              @php
                                  $totalAdminPost = \App\Models\Admin_post::count();
                              @endphp
                              <h3>{{ $totalAdminPost }}</h3>
          ...
          <!-- right col -->
            ...
            {{-- @php
                ...
                @endphp
                <p>Hashed Password for 'demo': {{ $hashedPassword }}</p> --}}
        </section>
        <!-- /.content -->
    </div>
@endsection
